...
def print_strategy(OwnPokers, NotAppeared, enemy_hand, public1, public2, nleft1, nleft2, player):
    ...
    print(sorted(proba_dict.items(), key=lambda x: x[1])[-5:])
...
if __name__ == '__main__':
    ...
    enemy_hand = ['5S', '5D']
    public = ['6D', '7C', '7H']
    print_strategy(OwnPokers, NotAppeared, enemy_hand, public, [], 0, 1, 0)
    ...
    enemy_hand = []
    public = ['6C', '7D', '8H']
    print_strategy(OwnPokers, NotAppeared, enemy_hand, [], public, 1, 0, 1)
